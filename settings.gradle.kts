...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("velocity", "com.velocitypowered:velocity-api:4.0.0")
            library("paper", "io.papermc.paper:paper-api:26.2.build.121-stable")
            plugin("shadow", "com.gradleup.shadow").version("9.6.1")
            plugin("pluginyml", "net.minecrell.plugin-yml.bukkit").version("0.6.0")
            plugin("spotless", "com.diffplug.spotless").version("8.10.1")
        }
    }
}
