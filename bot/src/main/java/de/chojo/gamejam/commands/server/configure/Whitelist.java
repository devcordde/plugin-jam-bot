...
public class Whitelist implements SlashHandler {
    private static final Logger log = getLogger(Whitelist.class);
    ...
    public void onSlashCommand(SlashCommandInteractionEvent event, EventContext context) {
        ...
        var request = optServer.get().requestBuilder("v1/config/whitelist")
