    ...
    public Votes(Guilds guilds) {
        super(Slash.of("votes", "command.votes.description")
                .subCommand(SubCommand.of("vote", "command.votes.vote.description")
                        ...
                        .argument(Argument.text("team", "command.votes.vote.options.team.description").asRequired()
                                          .withAutoComplete())
                        .argument(Argument.integer("points", "command.votes.vote.options.points.description").asRequired()
                                          .withAutoComplete()))
