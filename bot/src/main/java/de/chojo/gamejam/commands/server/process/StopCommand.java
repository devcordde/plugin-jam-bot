...
public class StopCommand {
    ...
    @Inject
    public StopCommand(ServerService serverService, CommandContextProvider commandContextProvider) {
        this.serverService = serverService;
        this.commandContextProvider = commandContextProvider;
    }

    @Command(value = "server process stop")
    public void onCommand(CommandEvent event) {
        ...
        serverService.stopServer(teamServer);
        event.reply("command.server.process.stop.message.stopping");
    }
}
