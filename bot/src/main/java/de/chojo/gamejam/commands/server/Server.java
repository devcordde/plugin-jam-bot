        ...
        return Slash.of("server", "command.server.description")
                ...
                .group(Group.of("process", "command.server.process.description")
                        ...
                        .subCommand(SubCommand.of("console", "command.server.process.console.description")
                                ...
                                .argument(Argument.text("command", "command.server.process.console.options.command.description").asRequired()))
                ...
                .group(Group.of("upload", "command.server.upload.description")
                        .subCommand(SubCommand.of("world", "command.server.upload.world.description")
                                ...
                                .argument(Argument.text("url", "command.server.upload.world.options.url.description"))
                                .argument(Argument.attachment("file", "command.server.upload.world.options.file.description")))
                        .subCommand(SubCommand.of("plugin", "command.server.upload.plugin.description")
                                .handler(new Plugin(this))
                                .argument(Argument.attachment("file", "command.server.upload.plugin.options.file.description")
                                                  .asRequired()))
                        .subCommand(SubCommand.of("plugindata", "command.server.upload.plugindata.description")
                                ...
                                .argument(Argument.text("path", "command.server.upload.plugindata.options.path.description")
                                                  .asRequired()
                                                  .withAutoComplete())
                                .argument(Argument.attachment("file", "command.server.upload.plugindata.options.file.description")
                                                  .asRequired())))
                .group(Group.of("download", "command.server.download.description")
                        .subCommand(SubCommand.of("plugindata", "command.server.download.plugindata.description")
                                ...
                                .argument(Argument.text("path", "command.server.download.plugindata.options.path.description")
                                                  .asRequired()
                                                  .withAutoComplete())))
                .group(Group.of("plugins", "command.server.plugins.description")
                        .subCommand(SubCommand.of("install", "command.server.plugins.install.description")
                                ...
                                .argument(Argument.text("plugin", "command.server.plugins.install.options.plugin.description")
                                                  .asRequired()
                                                  .withAutoComplete()))
                        .subCommand(SubCommand.of("uninstall", "command.server.plugins.uninstall.description")
                                ...
                                .argument(Argument.text("plugin", "command.server.plugins.uninstall.options.plugin.description").asRequired()
                                                  .withAutoComplete())
                                .argument(Argument.bool("deletedata", "command.server.plugins.uninstall.options.deletedata.description")
                                                  .asRequired())))
                .group(Group.of("configure", "command.server.configure.description")
                        ...
                        .subCommand(SubCommand.of("maxplayers", "command.server.configure.maxplayers.description")
                                ...
                                .argument(Argument.integer("amount", "command.server.configure.maxplayers.options.amount.description").asRequired()))
                        .subCommand(SubCommand.of("spectatoroverflow", "command.server.configure.spectatoroverflow.description")
                                ...
                                .argument(Argument.bool("state", "command.server.configure.spectatoroverflow.options.state.description").asRequired()))
                        .subCommand(SubCommand.of("whitelist", "command.server.configure.whitelist.description")
                                .handler(new Whitelist(this))
                                .argument(Argument.bool("state", "command.server.configure.whitelist.options.state.description").asRequired())))
                .build();
    }
